const storeProducts = [
    {
        id: 1,
        name: "Pure, Superduper Organic Cocoa Powder",
        price: "250",
    ...
    },
    {
        ...
        price: "137",
        productinfo: "Experience bliss with Lindt Lindor smooth melting milk chocolate truffles. The Lindt Master Chocolatiers combine expertise and the finest ingredients to produce the perfectly round milk chocolate shell with an irresistibly smooth melting filling. Comes in a bag of 137 grams",
        ingredients: "socker, vegetabiliskt fett (kokos, palmkärna), kakaosmör, kakaomassa, helMJÖLKspulver, skumMJÖLKspulver, LAKTOS, vattenfritt MJÖLKfett, emulgeringsmedel (SOJA-lecitin), KORNmaltextrakt, aromer. Kan innehålla HASSELNÖTTER, andra NÖTTER.",
        images:  ["img/cacao-product-2-1.webp"]
    },
    {
        id: 3,
        name: "Mörk Choklad - 100% Ren Kakao",
        price: "89",
    ...
    {
        id: 6,
        name: "Vår Hemmagjorda Chokladglass",
        price: "69",
